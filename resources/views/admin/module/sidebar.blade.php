    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                <li class="active"><a href="{{ route('admin.categories.index')}}"><i class="fa fa-circle-o"></i> @lang('admin.sidebar.category.list')</a></li>
                <li><a href="{{ route('admin.categories.create')}}"><i class="fa fa-circle-o"></i> @lang('admin.sidebar.category.add')</a></li>
            </ul>
        </li>
        <li class="treeview">
            <a href="#">
