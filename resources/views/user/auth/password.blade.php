...
@section('content')
  <div class="content-wrapper p-60">
    ...
    <a class="btn btn-success btn-md" href="{{ route('user.profile')}}">@lang('user.show')</a>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <form method="POST" role="form" enctype="multipart/form-data" action="{{ route('user.password') }}" class="form-create col-sm-4">
                @csrf
